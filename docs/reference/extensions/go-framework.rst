.. meta::
    :description: Reference documentation for the Rockcraft Go framework extension, which configures Go application rocks by compiling and installing the binary.
