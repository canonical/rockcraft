.. meta::
    :description: Reference documentation for the Rockcraft spring-boot-framework extension. Streamlines building Spring Boot rocks by packaging and copying the JAR file to the image.
