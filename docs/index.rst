...
complex operations, at build time, without the need for massaging nor stripping down the build environment from where your final container image originates.
...
a container image which is built from Ubuntu, for Ubuntu users. Rockcraft implements source-to-image best-practice designs, handling all the repetitive and boilerplate steps of a build and directing your focus to what really 
