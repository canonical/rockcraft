.. meta::
    :description: How to publish a rock to an OCI container registry, such as Docker Hub, using Skopeo. Push and tag rock images for distribution and deployment.
